...
class ResetPasswordController extends Controller
{
    ...
    public function VerifyOTP(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        try {
            ...
            $user->update([
                ...
                'reset_password_token_expires_at' => Carbon::now()->addHour(),
            ]);
    ...
    public function ResetPassword(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        try {
            ...
            if (!empty($user->reset_password_token) && $user->reset_password_token === $request->token && $user->reset_password_token_expires_at >= Carbon::now()) {
                $user->update([
